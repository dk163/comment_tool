  ...
  extends JFrame
{
  ...
  private void initHander()
  {
    ...
    this.mHeadCheckButton = new JCheckBox("生成头文�?");
    ...
    this.mTabPane.addTab("生成头文�?", null, handerFramePanel, "生成头文�?");
  }
    ...
    implements ActionListener
  {
    ...
    public void actionPerformed(ActionEvent e)
    {
      ...
      else
      {
        ...
        {
          Class<HeaderFileModel> headerFileModelClass = HeaderFileModel.class;
          Field[] headerFileModelFileds = headerFileModelClass
            .getDeclaredFields();
          int fieldLen = headerFileModelFileds.length;
          ...
          for (int i = 0; i < fieldLen; i++)
          {
            ...
            if (!fieldName.equals("sCaptionMap")) {
              try
              {
                ...
                Method method = headerFileModelClass
                  .getMethod("set" + temp, new Class[] { argTypes });
                String tmp = ((JTextField)MainView.this.mTextFieldMap.get(fieldName))
                  .getText().toString();
                if (tmp.length() == 0)
                {
                  if (fieldName.equals("mAuthor"))
          ...
          {
            JOptionPane.showConfirmDialog(null, "请�?�择文件种类", "选择种类", 
              -1);
            return;
          }
          if ((!MainView.this.mXmlRadioButton.isSelected()) && 
            (!MainView.this.mJavaRadioButton.isSelected()) && 
            (!MainView.this.mMKRadioButton.isSelected()))
          {
            JOptionPane.showConfirmDialog(null, "请�?�择生成文件类型", "文件类型", 
              -1);
            return;
          }
          int category = 2;
          ...
          if ((category != 0) && 
            (((JTextField)MainView.this.mTextFieldMap.get("mComment"))
            .getText().toString().length() == 0))
          {
            JOptionPane.showConfirmDialog(null, 
              "Modify Comment(what, where, why)不能为空", "不能为空", 
              -1);
            return;
          }
          String type = "java";
          ...
          MainView.this.mResult = MainView.this.mController.getHeader(category, type, MainView.this.mHeaderFileModel);
        ...
        else if (e.getSource().equals(MainView.this.mNoteJButton))
        {
          ...
          for (int i = 0; i < fieldLen; i++)
          {
            ...
            if (!fieldName.equals("sCaptionMap")) {
              try
              {
                String temp = fieldName.substring(0, 1).toUpperCase() + 
                  fieldName.substring(1);
                Method method = noteModelClass.getMethod("set" + 
                  temp, new Class[] { argTypes });
                String tmp = ((JTextField)MainView.this.mNoteTextFieldMap.get(
                  fieldName)).getText().toString();
                if ((tmp.length() == 0) && (
                  (fieldName.equals("mAuthor")) || 
                  (fieldName.equals("mDate"))))
                {
                  JOptionPane.showConfirmDialog(null, 
                    (String)NoteModel.sCaptionMap.get(fieldName) + 
                    "不能为空", "不能为空", 
                    -1);
                  return;
                }
          ...
          {
            JOptionPane.showConfirmDialog(null, "请�?�择生成文件类型", "选择类型", 
              -1);
            return;
          }
          ...
          {
            JOptionPane.showConfirmDialog(null, "请�?�择生成行数", "选择行数", 
              -1);
            return;
          }
          String type = "java";
          ...
          MainView.this.mResult = MainView.this.mController.getNote(
            ...
            MainView.this.mJOperateCombobBox.getSelectedItem().toString(), 
            lineNum, type, MainView.this.mNoteModel);
    ...
    private void createConfigFile(String mAuthor, String mEmail)
    {
      ...
      //   3: astore 4
      //   5: aload_0
      //   6: getfield 12	com/tct/autotool/view/MainView$MyListener:this$0	Lcom/tct/autotool/view/MainView;
      //   9: new 334	java/io/File
      //   12: dup
      //   13: ldc_w 336
      //   16: invokespecial 338	java/io/File:<init>	(Ljava/lang/String;)V
      //   19: invokestatic 339	com/tct/autotool/view/MainView:access$20	(Lcom/tct/autotool/view/MainView;Ljava/io/File;)V
      //   22: aload_0
      //   23: getfield 12	com/tct/autotool/view/MainView$MyListener:this$0	Lcom/tct/autotool/view/MainView;
      //   26: invokestatic 343	com/tct/autotool/view/MainView:access$21	(Lcom/tct/autotool/view/MainView;)Ljava/io/File;
      //   29: invokevirtual 347	java/io/File:exists	()Z
      //   32: ifne +14 -> 46
      //   35: aload_0
      //   36: getfield 12	com/tct/autotool/view/MainView$MyListener:this$0	Lcom/tct/autotool/view/MainView;
      //   39: invokestatic 343	com/tct/autotool/view/MainView:access$21	(Lcom/tct/autotool/view/MainView;)Ljava/io/File;
      //   42: invokevirtual 350	java/io/File:createNewFile	()Z
      //   45: pop
      //   46: new 353	java/util/Scanner
      //   49: dup
      //   50: aload_0
      //   51: getfield 12	com/tct/autotool/view/MainView$MyListener:this$0	Lcom/tct/autotool/view/MainView;
      //   54: invokestatic 343	com/tct/autotool/view/MainView:access$21	(Lcom/tct/autotool/view/MainView;)Ljava/io/File;
      ...
      //   167: dup
      //   168: aload_0
      //   169: getfield 12	com/tct/autotool/view/MainView$MyListener:this$0	Lcom/tct/autotool/view/MainView;
      //   172: invokestatic 343	com/tct/autotool/view/MainView:access$21	(Lcom/tct/autotool/view/MainView;)Ljava/io/File;
      ...
      //   282: aload 7
      //   284: invokevirtual 156	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
